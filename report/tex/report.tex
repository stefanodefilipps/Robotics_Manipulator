...
\end{figure}
\begin{figure}[H]
\subfloat[Control points' distances from $1^{st}$ obstacle]{\img2{2obs}{control points distances.eps}{.5}}\hfill
\subfloat[Control points' distances from $2^{nd}$ obstacle]{\img2{2obs}{control points distances 2.eps}{.5}}
\end{figure}
...
\end{figure}
\begin{figure}[H]
\subfloat[Control points' distances from $1^{st}$ obstacle]{\img2{3obs}{control points distances.eps}{.3}}\hfill
\subfloat[Control points' distances from $2^{nd}$ obstacle]{\img2{3obs}{control points distances 2.eps}{.3}}\hfill
\subfloat[Control points' distances from $3^{rd}$ obstacle]{\img2{3obs}{control points distances 3.eps}{.3}}
\end{figure}
