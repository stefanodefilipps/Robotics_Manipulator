...
\section{Code}
\begin{itemize}
\item Flacco? (flaccoController.cpp)
\item Reordering? (flaccoController.cpp)
\item Control points? (Manipulator.cpp)
\item Control algorithm? (vrepExtKUKA.cpp)
\end{itemize}
...
\end{lstlisting}
\lstinputlisting[language = C++, firstline=13, lastline=25]{../../Manipulator.cpp}
\section{Results}
